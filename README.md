...
This fork uses rotary encoders instead of analog potentiometers. The device, powered by a Raspberry Pi Pico, sends the change in volume instead of a new volume setting to the modified desktop client. Mute button support is WIP.
